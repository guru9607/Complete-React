...
//12).What is `NPM`?
//`npm` is a package manager for javascript that allows developers to easily manage and share reusable code packages. It host all the different libraries we can use.
// We initialise it into our existing project using `npm init -y`
